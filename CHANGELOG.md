...
- Standard Readme README (Install, Usage, API, Contributing; License last).
- Community health files: Code of Conduct, Support, Security, Governance, issue and pull-request templates.
- Family documentation contract: `docs/DOCUMENTATION.md` (Diátaxis + Standard Readme + GitHub community profile).
